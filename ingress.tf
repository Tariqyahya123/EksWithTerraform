data "aws_iam_policy_document" "eks-ingress-policy" {
  statement {
...
resource "aws_iam_policy" "eks-ingress-policy" {
  name = "eks-ingress-policy"
...
resource "aws_iam_role" "ingress-eks-role" {
  assume_role_policy = data.aws_iam_policy_document.eks-ingress-policy.json
  name               = "eks-ingress-role"
}


resource "aws_iam_role_policy_attachment" "eks-ingress-attach" {
  role       = aws_iam_role.ingress-eks-role.name
